...
exports.getIAMKey = function(program, logger, alksAccount, alksRole, forceNewSession, cb){
    async.waterfall([
        ...
        function(developer, password, alksAccount, alksRole, existingKeys, callback){
            ...
            alks.createIamKey(data, password, { debug: program.verbose, ua: utils.getUA() }, function(err, key){
                if(!err){
