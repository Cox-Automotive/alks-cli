        ...
        function(developer, auth, alksAccount, alksRole, existingKeys, callback){
            ...
            alks.getAccessToken({
                ...
                alksCreate.getLoginRole({
                    ...
                    let duration = Math.min(_.last(durations), 12);
                    ...
                    alksCreate.getIAMKeys({
                        ...
                        keys.addKey(key.accessKey, key.secretKey, key.sessionToken,
                            data.alksAccount, data.alksRole, data.expires, auth, true);
                        callback(null, key, developer, auth);
                    ...
                    callback(error, null, developer, auth);
                });
            }).catch(error => {
