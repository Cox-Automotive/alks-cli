...
var AWS_SIGNIN_URL    = 'https://signin.aws.amazon.com/federation', AWS_CONSOLE_URL   = 'https://console.aws.amazon.com/';
    ...
    request({
        ...
        if(err){
            ...
            if(!_.isEmpty(returnedData.SigninToken)){
                ...
                return callback(new Error('AWS didnt return sign in token!'));
            }
        }
    });
};
