...
exports.addKey = function(accessKey, secretKey, sessionToken, consoleURL, alksAccount, expires, password, callback){
...
exports.getKeyOutput = function(format, key, profile, force){
    ...
    _.each([ 'meta', '$loki', 'expires', 'consoleURL', 'alksAccount' ], function(attr){
        delete key[attr];
    });
