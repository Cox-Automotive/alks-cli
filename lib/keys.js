...
function getKeysCollection(callback){
    ...
    db.loadDatabase({}, function(){
        ...
        try{
            ...
            console.error('Error encountered during database transaction! Swallowing to preserve file integrity.');
            console.error(e);
        }
    });
}
...
exports.addKey = function(accessKey, secretKey, sessionToken, consoleURL, alksAccount, alksRole, expires, password, callback){
    getKeysCollection(function(err, keys){
        keys.insert({
            ...
            consoleURL:   encrypt(consoleURL, password),
...
exports.getKeys = function(password, callback){
    getKeysCollection(function(err, keys){
        ...
        _.each(data, function(keydata, i){
            ...
            keydata.consoleURL   = decrypt(keydata.consoleURL, password);
...
exports.getKeyOutput = function(format, key, profile, force){
    ...
    _.each([ 'meta', '$loki', 'expires', 'consoleURL', 'alksAccount', 'alksRole' ], function(attr){
        delete key[attr];
    });
