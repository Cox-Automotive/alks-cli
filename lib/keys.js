...
exports.addKey = function(accessKey, secretKey, sessionToken, guiURL, alksAccount, expires, password, callback){
    getKeysCollection(function(err, keys){
        keys.insert({ 
            ...
            guiURL:       encrypt(guiURL, password),
...
exports.getKeys = function(password, callback){
    getKeysCollection(function(err, keys){
        ...
        _.each(data, function(keydata, i){
            ...
            keydata.guiURL       = decrypt(keydata.guiURL, password);
...
exports.getKeyOutput = function(format, key, profile, force){
    ...
    _.each([ 'meta', '$loki', 'expires', 'guiURL', 'alksAccount' ], function(attr){
        delete key[attr];
    });
