...
var getPasswordFromKeystore_1 = require("../lib/getPasswordFromKeystore");
var getPasswordFromPrompt_1 = require("../lib/getPasswordFromPrompt");
var getStdErrPrompt_1 = require("../lib/getStdErrPrompt");
var isUrl_1 = require("../lib/isUrl");
var log_1 = require("../lib/log");
var saveDeveloper_1 = require("../lib/saveDeveloper");
        ...
        return tslib_1.__generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 3:
                    e_1 = _b.sent();
                    return [3 /*break*/, 4];
                case 4: return [4 /*yield*/, getPrompt('server', previousDeveloper === null || previousDeveloper === void 0 ? void 0 : previousDeveloper.server, 'ALKS server', isUrl_1.isURL)];
                case 5:
                    server = _b.sent();
                ...
                case 6:
                    userid = _b.sent();
                    log_1.log(commander_1.default, logger, 'getting existing password');
                    return [4 /*yield*/, getPasswordFromKeystore_1.getPasswordFromKeystore()];
                case 7:
                    password = _b.sent();
                    log_1.log(commander_1.default, logger, 'getting password');
                ...
                case 12:
                    ...
                    log_1.log(commander_1.default, logger, 'getting existing auth');
                    return [4 /*yield*/, getAuth_1.getAuth(commander_1.default, false)];
                case 13:
                    auth = _b.sent();
                    return [3 /*break*/, 15];
                case 14:
                ...
                case 15:
                    ...
                    return [4 /*yield*/, getAlksAccount_1.getAlksAccount(commander_1.default, opts)];
                case 16:
                    _a = _b.sent(), alksAccount = _a.alksAccount, alksRole = _a.alksRole;
                    log_1.log(commander_1.default, logger, 'Getting output formats');
                    promptData = {
                        type: 'list',
                        name: 'outputFormat',
                ...
                case 17:
                    ...
                    // create developer
                    log_1.log(commander_1.default, logger, 'saving developer');
                    _b.label = 18;
                case 18:
                ...
                case 20:
                    e2_1 = _b.sent();
                    if (e2_1) {
                        log_1.log(commander_1.default, logger, 'error saving! ' + e2_1.message);
                ...
                case 24:
                    err_1 = _b.sent();
                    return [2 /*return*/, errorAndExit_1.errorAndExit('Error configuring developer: ' + err_1.message)];
