...
var ensureConfigured_1 = require("../lib/ensureConfigured");
var errorAndExit_1 = require("../lib/errorAndExit");
var getAuth_1 = require("../lib/getAuth");
var getKeys_1 = require("../lib/getKeys");
var log_1 = require("../lib/log");
var obfuscate_1 = require("../lib/obfuscate");
    ...
    return tslib_1.__awaiter(this, void 0, void 0, function () {
        ...
        return tslib_1.__generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    auth = _a.sent();
                    log_1.log(commander_1.default, logger, 'getting existing sesions');
                    return [4 /*yield*/, getKeys_1.getKeys(auth, false)];
                case 3:
                    nonIamKeys = _a.sent();
                    log_1.log(commander_1.default, logger, 'getting existing iam sesions');
