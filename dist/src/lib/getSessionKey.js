...
function getSessionKey(alksAccount, alksRole, iamOnly, forceNewSession, filterFavorites) {
        ...
        return tslib_1.__generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 8:
                    ...
                    (0, log_1.log)('calling api to generate new keys/session for ' + duration + ' hours');
