        ...
        return tslib_1.__generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, (0, getAlksAccounts_1.getAlksAccounts)({ iamOnly: opts.iamOnly })];
                case 1:
                    alksAccounts = _a.sent();
                    return [4 /*yield*/, (0, getFavorites_1.getFavorites)()];
                case 2:
                    favorites = _a.sent();
                    (0, log_1.log)("Favorites: ".concat(favorites.toString()));
                    indexedAlksAccounts = alksAccounts
                        .map(function (alksAccount) {
                        return [alksAccount.account, alksAccount.role].join((0, getAccountDelim_1.getAccountDelim)());
                ...
                case 4:
                    ...
                    prompt = (0, getStdErrPrompt_1.getStdErrPrompt)();
                    return [4 /*yield*/, prompt([promptData])];
                case 5:
                    answers = _a.sent();
                    acctStr = answers.alksAccount;
                    data = acctStr.split((0, getAccountDelim_1.getAccountDelim)());
                    alksAccount = data[0];
                    alksRole = data[1];
                    return [2 /*return*/, {
