...
function getEnvironmentVariableSecretWarning(varName) {
    return cli_color_1.default.red("WARNING: Using the ".concat(varName, " environment variable is not recommended since other applications may accidentally log it. Proceed with caution."));
}
