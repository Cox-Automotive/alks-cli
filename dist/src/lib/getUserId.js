        ...
        return tslib_1.__generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    log_1.log(program, logger, 'using userid from CLI arg');
                ...
                case 1:
                    ...
                    log_1.log(program, logger, 'using userid from environment variable');
                ...
                case 3:
                    ...
                    if (!underscore_1.isEmpty(userid)) {
                        log_1.log(program, logger, 'using stored userid');
                        return [2 /*return*/, userid];
                    }
                    else if (prompt) {
                        // otherwise prompt the user (if we have program)
                        log_1.log(program, logger, 'no userid found, prompting user');
                        return [2 /*return*/, program ? getUserIdFromPrompt_1.getUserIdFromPrompt() : null];
                    }
                    else {
