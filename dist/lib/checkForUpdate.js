        ...
        return tslib_1.__generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    utils_1.log(null, logger, 'needs update? ' + (needsUpdate ? 'yes' : 'no'));
                    ...
                    utils_1.showBorderedMessage(40, msg);
                    return [3 /*break*/, 5];
                case 2:
                    ...
                    return [4 /*yield*/, developer_js_1.getDeveloper()];
                case 3:
                    developer = _a.sent();
                    utils_1.log(null, logger, 'db');
                    developer.lastVersion = currentVersion;
                    return [4 /*yield*/, developer_js_1.saveDeveloper(developer)];
                case 4:
                    _a.sent();
                    _a.label = 5;
