...
(function () {
    return tslib_1.__awaiter(this, void 0, void 0, function () {
        ...
        return tslib_1.__generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, developer_1.getPasswordFromPrompt()];
                case 1:
                    password = _a.sent();
                    utils_1.log(commander_1.default, logger, 'saving password');
                    _a.label = 2;
                case 2:
                    _a.trys.push([2, 4, , 5]);
                    return [4 /*yield*/, developer_1.storePassword(password)];
                case 3:
                    _a.sent();
                ...
                case 4:
                    err_1 = _a.sent();
                    utils_1.log(commander_1.default, logger, 'error saving password! ' + err_1.message);
                    utils_1.passwordSaveErrorHandler(err_1);
                    return [3 /*break*/, 5];
                case 5:
