...
var keys = tslib_1.__importStar(require("../lib/keys"));
...
(function () {
    return tslib_1.__awaiter(this, void 0, void 0, function () {
        ...
        return tslib_1.__generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, Developer.ensureConfigured()];
                case 1:
                    _a.sent();
                ...
                case 2:
                    auth = _a.sent();
                    utils.log(commander_1.default, logger, 'getting existing sesions');
                    return [4 /*yield*/, keys.getKeys(auth, false)];
                case 3:
                    nonIamKeys = _a.sent();
                    utils.log(commander_1.default, logger, 'getting existing iam sesions');
                    return [4 /*yield*/, keys.getKeys(auth, true)];
                case 4:
                    iamKeys = _a.sent();
