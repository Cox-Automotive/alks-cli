        ...
        return tslib_1.__generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    key = _a.sent();
                    return [3 /*break*/, 4];
                case 2: return [4 /*yield*/, iam_1.getIAMKey(commander_1.default, logger, alksAccount, alksRole, forceNewSession, filterFaves)];
                case 3:
                    key = _a.sent();
                    _a.label = 4;
                ...
                case 8:
                    ...
                    return [4 /*yield*/, developer_1.saveMetadata({
                ...
                case 10:
                    err_2 = _a.sent();
                    return [2 /*return*/, utils_1.errorAndExit('Unable to save metadata!', err_2)];
                case 11:
