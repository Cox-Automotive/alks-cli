...
var trustArn = commander_1.default.trustarn;
...
utils_1.log(commander_1.default, logger, 'validating trust arn: ' + trustArn);
if (underscore_1.default.isEmpty(trustArn) || !TRUST_ARN_REGEX.test(trustArn)) {
    utils_1.errorAndExit('The trust arn provided contains illegal characters. It must be ' +
        trustArnDesc);
}
    ...
    return tslib_1.__awaiter(this, void 0, void 0, function () {
        ...
        return tslib_1.__generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 5:
                    auth = _b.sent();
                    utils_1.log(commander_1.default, logger, 'calling api to create trust role: ' + roleName);
