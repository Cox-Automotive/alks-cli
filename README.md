...
To install and use the ALKS CLI, you will need Node.js (version 6 or greater, LTS version recommended!) and NPM ([nodejs.org](https://nodejs.org/en/download/package-manager)).
